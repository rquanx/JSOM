 ...
 */
var ResultMessage = function (success, data, message = "") {
 ...
 */
var ServiceInfo = function (site = "", listTitle = "", listId = "") {
    this.site = site;
 ...
 * @param {string} listId  设置默认操作列表id
 */
var SharePointService = function (site = "", listTitle = "", listId = "") {
 ...
 * @param {string} title
 */
SharePointService.prototype.setListTitle = function (title) {
 ...
 * 
 */
SharePointService.prototype.getSiteUserInfo = function (caml, fields = []) {
    let info = this.ServiceInfo;
    ...
    function getItem(res, rej) {
        ...
        var camlQuery = SharePointService.getCamlQuery(caml);
 ...
 */
SharePointService.prototype.getListItem = function (caml, fields = [], pageInfo = "") {
    let info = this.ServiceInfo;

    function getPageItem(res, rej) {
        var olist = SharePointService.getList(info);
        var camlQuery = SharePointService.getCamlQuery(caml, pageInfo);
        var collListItem = olist.getItems(camlQuery);
 ...
 * 是否可以增加include? 
 */
SharePointService.prototype.getListItemById = function (id) {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} } } attributes
 */
SharePointService.prototype.updateListItemById = function (id, attributes) {
    let info = this.ServiceInfo;

    function updateItem(res, rej) {
        var oList = SharePointService.getList(info); //读取表
        var oListItem = oList.getItemById(id); //根据ID字段搜索表内容，唯一？			
        SharePointService.setListItem(oListItem, attributes);
 ...
 * @param { { field: {type: string, value: string} } } attributes
 */
SharePointService.prototype.updateListItemByCaml = function (caml, attributes) {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} }[] } attributesList
 */
SharePointService.prototype.updateListItemsByIdList = function (idList, attributesList) {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} }} attributes
 */
SharePointService.prototype.updateListItemsByCaml = function (caml, attributes) {
    let info = this.ServiceInfo;
 ...
 * @param {string | number} id 
 */
SharePointService.prototype.deleteListItemById = function (id) {
    let info = this.ServiceInfo;

    function deleteItem(res, rej) {
        var list = SharePointService.getList(info);
 ...
 * @param {any} caml 
 */
SharePointService.prototype.deleteListItemsByCaml = function (caml) {
    let info = this.ServiceInfo;
 ...
 * @param {string[] | number[]} idList
 */
SharePointService.prototype.deleteListItemsByIdList = function (idList) {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} } } attributesObj
 */
SharePointService.prototype.createListItem = function (subFolderPath, attributesObj) {
    let info = this.ServiceInfo;

    function createItem(res, rej) {
        let list = SharePointService.getList(info);
        ...
        SharePointService.setListItem(newItem, attributesObj);
        newItem.update();
 ...
 */
SharePointService.prototype.isCurrentUserMemberOfGroup = function (groupName) {
    let info = this.ServiceInfo;
 ...
 * @returns {Promise<ResultMessage>}
 */
SharePointService.prototype.isUserMemberOfGroup = function (userId, groupName) {
    let info = this.ServiceInfo;
 ...
 * @param { string } groupName 要检查的组名
 */
SharePointService.prototype.getUserOfGroup = function (groupName) {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} }} attributesObj 更新的字段值
 * @param { string | number} isNewFileName  是否重命名
 */
SharePointService.prototype.updateDocumentLibraryItemById = function (id, newFileName, arrayBuffer, attributesObj, isNewFileName = false) {
    var self = this;
    var fileDir = "";
 ...
 */
SharePointService.prototype.overWriteFile = function (arrayBuffer, fileUrl, folderName) {
    let info = this.ServiceInfo;

    function overWrite(res, rej) {
        let clientContext = info.context;
        let oList = SharePointService.getList(info);
 ...
 * @param { any } arrayBuffer 二进制文件数据
 * @param { string } folderName  文件夹名
 * @param { { field: {type: string, value: string} } } attributesObj 字段数据
 */
SharePointService.prototype.createDocumentLibraryItem = function (fileUrl, arrayBuffer, folderName, attributesObj) {
    let info = this.ServiceInfo;
    ...
    function createItem(res, rej) {
        ...
        SharePointService.setListItem(myListItem, attributesObj);
        myListItem.update();
 ...
 * @param { { field: {type: string, value: string} } } attributesObj 字段数据
 */
SharePointService.prototype.createFolder = function (subFolderPath, folderName, attributesObj = {}) {
    let info = this.ServiceInfo;
    ...
    function createItem(res, rej) {
        ...
        SharePointService.setListItem(oListItem, attributesObj);
        oListItem.update();
        clientContext.executeQueryAsync(onSuccess, onError);
...
/** 
 * 检查用户在当前设置的站点下的权限
 * @param {anu} permission 权限枚举
 */
SharePointService.prototype.checkSitePermission = function (permission) {
    let info = this.ServiceInfo;
 ...
 * @param {anu} permission 权限枚举
 */
SharePointService.prototype.checkListPermission = function (permission) {
    let info = this.ServiceInfo;
 ...
 * @param {*} caml   
 */
SharePointService.prototype.renderListData = function (caml) {
    let info = this.ServiceInfo;
 ...
 * 读取指定列表GUID
 */
SharePointService.prototype.getListGUID = function () {
    let info = this.ServiceInfo;
 ...
 * @param { { field: {type: string, value: string} } } attributesObj
 */
SharePointService.setListItem = function (newItem, attributesObj) {
 ...
 * @param {any} info
 */
SharePointService.getList = function (info) {
    var list;
    if (info.listTitle) {
 ...
 */
SharePointService.getCamlQuery = function (caml, pageInfo = "") {
